...
public class RefatoracaoOrdenacaoMap {
    ...
    public static void main(String[] args) {
       ...
       /*  Set<Map.Entry<Integer, Contato>> set = new TreeSet<>(new ComparatorOrdemNumerica());
        ...
        //Refatorando com classe anonima
        ...
        //Refatorando com o metodo statico do comparator, lembrando que o metodo comparator ja tem uma metodod que ajuda nas comparaçoes
        /*
